...
export default async function CategoryDealsPage({
    ...
    const categoryRecord = categoryData as Category;
                ...
                <div className="mx-auto max-w-7xl px-6 py-12">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-4xl font-black tracking-tight text-white md:text-5xl">
                            {categoryRecord.name} deals
                        </h1>

                        <p className="mt-4 text-lg leading-8 text-slate-300">
                            {categoryRecord.description ||
                                `Browse approved ${categoryRecord.name.toLowerCase()} deals curated in DealSeal.`}
                        </p>
                ...
                <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
                    <div>
                        <h2 className="text-2xl font-black text-slate-950">
                            Latest {categoryRecord.name} deals
                        </h2>
                ...
                {deals.length === 0 ? (
                    <div className="rounded-3xl border border-dashed border-slate-300 bg-white p-10 text-center">
                        <h3 className="text-xl font-bold text-slate-900">
                            No approved {categoryRecord.name} deals yet
                        </h3>
                        <p className="mt-2 text-slate-500">
                            Add or approve deals for this category from the admin dashboard.
                        </p>
                        <a
                            href="/admin"
                                ...
                                >
                                    ...
                                    <div className="p-5">
                                        ...
                                        <div className="mb-4 space-y-1 text-xs text-slate-500">
                                            <p>Retailer: {retailer?.name ?? "Unknown"}</p>
